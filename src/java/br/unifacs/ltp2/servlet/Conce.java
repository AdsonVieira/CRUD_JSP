 ...
 * @author adson
 */
@WebServlet(name = "Conce", urlPatterns = {"/Conce"})
public class Conce extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher view = getServletContext().getRequestDispatcher("/listCon.jsp");
