...
public class ListCar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        carroList = (ArrayList<Carro>) carroDao.readJoin();
        request.setAttribute("carroList", carroList);

        RequestDispatcher view = getServletContext().getRequestDispatcher("/listCar.jsp");
