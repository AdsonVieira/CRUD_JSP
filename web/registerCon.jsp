...
<html>
    ...
    <body>
        <div class="row ">
            ...
            <div class="col s9 ">
                <h3 style="margin-left: 10px;font-size: 45px;font-weight: 100;color: #222;"> Cadastrar Concessionária <h3>     
                    <div class="row">
                        <form class="col s7" method="POST" action="ConCreate">  
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <input name="cnpj" id="modelo" type="text" class="validate">
